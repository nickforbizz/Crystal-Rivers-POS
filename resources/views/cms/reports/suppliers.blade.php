        ...
        <div class="col-md-12 p-2">
            <div class="card">
                <div class="card-body">
                    ...
                    <canvas id="supplierChart_Area" height="120"></canvas>
...
<script>
    $(document).ready(function() {
        $('#select_year').change(function() {
            var year = $(this).val();
            window.location.href = '{{ route("reports.suppliers") }}?year=' + year;
        });
    ...
    loadChart(report_data, 'supplierChart_Area', 'User', selected_year)
